...
class MessageType(Enum):
    ...
    PLAYER_FLEET_MOVEMENT_ALLOWED = 23
    BUILDING_START = 13
    BUILDING_COMPLETED = 14
    BUILDING_UPGRADE_START = 15
    BUILDING_UPGRADE_COMPLETED = 16
    BUILDING_DESTROYED = 17
    BUILDING_INSUFFICIENT_RESOURCES = 18
    BUILDING_REQUEST = 19
    BUILDING_UPGRADE_REQUEST = 20
    MODIFIER_PLAYER_RESOURCE = 21
    MODIFIER_BUILDING = 22
