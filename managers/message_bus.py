...
class MessageType(Enum):
    ...
    PLAYER_FLEET_MOVE = 9
    PLAYER_FLEET_LAND = 10
    PLAYER_FLEET_MOVEMENT_INTERRUPT = 11
    PLAYER_FLEET_ARRIVE = 12
    PLAYER_FLEET_MOVEMENT_ALLOWED = 13
    PLAYER_EXPLORE_WORLD = 14
    BUILDING_START = 15
    BUILDING_COMPLETED = 16
    BUILDING_UPGRADE_START = 17
    BUILDING_UPGRADE_COMPLETED = 18
    BUILDING_DESTROYED = 19
    BUILDING_INSUFFICIENT_RESOURCES = 20
    BUILDING_REQUEST = 21
    BUILDING_UPGRADE_REQUEST = 22
    MODIFIER_PLAYER_RESOURCE = 23
    MODIFIER_BUILDING = 24
    INTERSECTION_EVENT = 25
